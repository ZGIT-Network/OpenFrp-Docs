...
| login to server failed: `XXX` | 登录节点失败, 请检查网络连接: `XXX` | [点此查看详细说明] |
| connect to local service [`XXX`] error: `YYY` | 连接映射目标 [`XXX`] 失败, 请检查本地服务是否打开: `YYY` | [点此查看详细说明] |
...
> **我们推荐使用Ez Startup启动您的隧道,可以避免 [错误列表中](#error-list) 大部分问题。**
